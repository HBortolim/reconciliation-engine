...
func generatePixTestData() {
	...
	for i := 0; i < 10; i++ {
		...
		records[i] = common.TransactionRecord{
			...
			AmountCents:            int64(rand.Intn(100000)),
			NetAmountCents:         int64(rand.Intn(100000)),
...
func generateCNABTestData() {
	...
	for i := 0; i < 15; i++ {
		...
		records[i] = common.TransactionRecord{
			...
			CounterpartyDocument:   generateDocument(),
			CounterpartyName:       generateCounterpartyName(),
			AmountCents:            int64(rand.Intn(500000)),
			FeeCents:               int64(rand.Intn(1000)),
			NetAmountCents:         int64(rand.Intn(500000)),
